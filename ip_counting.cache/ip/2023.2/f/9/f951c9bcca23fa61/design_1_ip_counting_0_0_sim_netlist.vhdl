...
architecture STRUCTURE of decalper_eb_ot_sdeen_pot_pi_dehcac_xnilix_ip_counting_v1_0_S00_AXI is
  ...
  signal counting_reg : STD_LOGIC_VECTOR ( 31 downto 0 );
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].byte_ram_reg_0_63_0_2\: unisim.vcomponents.RAM64M
     port map (
      ...
      ADDRD(0) => write_addr,
      DIA => \wdata_reg_n_0_[0]\,
      DIB => \wdata_reg_n_0_[1]\,
      DIC => \wdata_reg_n_0_[2]\,
      DID => '0',
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].byte_ram_reg_0_63_3_5\: unisim.vcomponents.RAM64M
     port map (
      ...
      ADDRD(5 downto 1) => B"00000",
      ADDRD(0) => write_addr,
      DIA => \wdata_reg_n_0_[3]\,
      DIB => \wdata_reg_n_0_[4]\,
      DIC => \wdata_reg_n_0_[5]\,
      DID => '0',
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].byte_ram_reg_0_63_6_7\: unisim.vcomponents.RAM64M
     port map (
      ...
      ADDRD(5 downto 1) => B"00000",
      ADDRD(0) => write_addr,
      DIA => \wdata_reg_n_0_[6]\,
      DIB => \wdata_reg_n_0_[7]\,
      DIC => '0',
      DID => '0',
...
\counting_reg[0]_i_2\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 1) => counting_reg(3 downto 1),
...
\counting_reg[12]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(15 downto 12)
    );
...
\counting_reg[16]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(19 downto 16)
    );
...
\counting_reg[20]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(23 downto 20)
    );
...
\counting_reg[24]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(27 downto 24)
    );
...
\counting_reg[28]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(31 downto 28)
    );
...
\counting_reg[4]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(7 downto 4)
    );
...
\counting_reg[8]_i_1\: unisim.vcomponents.CARRY4
     port map (
      ...
      S(3 downto 0) => counting_reg(11 downto 8)
    );
