...
-- Date        : Mon Feb  5 01:24:15 2024
-- Host        : Hanashobu running 64-bit major release  (build 9200)
-- Command     : write_vhdl -force -mode funcsim
--               c:/Workspace/Projects/ip_counting/ip_counting.gen/sources_1/bd/design_1/ip/design_1_ip_counting_0_0/design_1_ip_counting_0_0_sim_netlist.vhdl
...
entity design_1_ip_counting_0_0_ip_counting_v1_0_S00_AXI is
  port (
  ...
  attribute ORIG_REF_NAME of design_1_ip_counting_0_0_ip_counting_v1_0_S00_AXI : entity is "ip_counting_v1_0_S00_AXI";
end design_1_ip_counting_0_0_ip_counting_v1_0_S00_AXI;

architecture STRUCTURE of design_1_ip_counting_0_0_ip_counting_v1_0_S00_AXI is
  ...
  signal axi_araddr00_in : STD_LOGIC_VECTOR ( 5 downto 2 );
  ...
  signal axi_awaddr00_in : STD_LOGIC_VECTOR ( 5 downto 2 );
  ...
  signal itr : STD_LOGIC_VECTOR ( 5 downto 0 );
  signal \itr[0]_i_1_n_0\ : STD_LOGIC;
  signal \itr[1]_i_1_n_0\ : STD_LOGIC;
  signal \itr[2]_i_1_n_0\ : STD_LOGIC;
  signal \itr[3]_i_1_n_0\ : STD_LOGIC;
  signal \itr[4]_i_1_n_0\ : STD_LOGIC;
  signal \itr[5]_i_1_n_0\ : STD_LOGIC;
  signal \itr[5]_i_2_n_0\ : STD_LOGIC;
  ...
  attribute SOFT_HLUTNM of \axi_araddr[6]_i_3\ : label is "soft_lutpair3";
  ...
  attribute SOFT_HLUTNM of \axi_awaddr[6]_i_3\ : label is "soft_lutpair2";
  attribute SOFT_HLUTNM of \axi_awaddr[6]_i_4\ : label is "soft_lutpair2";
  ...
  attribute SOFT_HLUTNM of \itr[1]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \itr[2]_i_1\ : label is "soft_lutpair17";
  attribute SOFT_HLUTNM of \itr[3]_i_1\ : label is "soft_lutpair4";
  attribute SOFT_HLUTNM of \itr[4]_i_1\ : label is "soft_lutpair4";
...
\BRAM_GEN[0].BYTE_BRAM_GEN[0].byte_ram_reg_0_63_0_2\: unisim.vcomponents.RAM64M
     port map (
      ...
      ADDRD(5 downto 0) => itr(5 downto 0),
...
\axi_awaddr[4]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B8BBFFFFB8880000"
        ...
        port map (
      I0 => axi_awaddr00_in(4),
      I1 => axi_awburst(0),
      I2 => \axi_awaddr0_inferred__0/i__carry_n_5\,
      I3 => aw_wrap_en,
      I4 => axi_awburst(1),
      I5 => axi_awaddr00_in(2),
...
\axi_awaddr[5]_i_2\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"B8BBFFFFB8880000"
        ...
        port map (
      I0 => axi_awaddr00_in(5),
      I1 => axi_awburst(0),
      I2 => \axi_awaddr0_inferred__0/i__carry_n_4\,
      I3 => aw_wrap_en,
      I4 => axi_awburst(1),
      I5 => axi_awaddr00_in(3),
...
\itr[0]_i_1\: unisim.vcomponents.LUT6
    generic map(
      INIT => X"8F0F0F0F0F0F0F0F"
    )
        port map (
      I0 => itr(2),
      I1 => itr(3),
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ip_counting_0_0_ip_counting_v1_0 is
  port (
  ...
  attribute ORIG_REF_NAME : string;
  attribute ORIG_REF_NAME of design_1_ip_counting_0_0_ip_counting_v1_0 : entity is "ip_counting_v1_0";
end design_1_ip_counting_0_0_ip_counting_v1_0;

architecture STRUCTURE of design_1_ip_counting_0_0_ip_counting_v1_0 is
begin
ip_counting_v1_0_S00_AXI_inst: entity work.design_1_ip_counting_0_0_ip_counting_v1_0_S00_AXI
     port map (
      GPIO => GPIO,
...
library UNISIM;
use UNISIM.VCOMPONENTS.ALL;
entity design_1_ip_counting_0_0 is
  port (
    s00_axi_aclk : in STD_LOGIC;
    s00_axi_aresetn : in STD_LOGIC;
  ...
  attribute NotValidForBitStream of design_1_ip_counting_0_0 : entity is true;
  attribute CHECK_LICENSE_TYPE : string;
  attribute CHECK_LICENSE_TYPE of design_1_ip_counting_0_0 : entity is "design_1_ip_counting_0_0,ip_counting_v1_0,{}";
  attribute DowngradeIPIdentifiedWarnings : string;
  attribute DowngradeIPIdentifiedWarnings of design_1_ip_counting_0_0 : entity is "yes";
  attribute X_CORE_INFO : string;
  attribute X_CORE_INFO of design_1_ip_counting_0_0 : entity is "ip_counting_v1_0,Vivado 2023.2";
end design_1_ip_counting_0_0;

architecture STRUCTURE of design_1_ip_counting_0_0 is
...
inst: entity work.design_1_ip_counting_0_0_ip_counting_v1_0
     port map (
      GPIO => GPIO,
